This repo contains material for the UNIX assignment of the bioinformatics course at Northeastern University, BIOL 2406 Computational Techniques in Genome Analysis (CTGA). You'll learn to navigate your own file system and that of the high-performance computing cluster via the command line, and to perform basic manipulations of files containing sequences and related information. The assignment consists of the three UNIX tutorials: 1_UNIX.md, 2_UNIX.md, and 3_UNIX.md. Other material in this repo is supplementary.

For Tutorials 1 and 2, you only need to submit each task (all begin with U, then a number). For Tutorial 3, submit all exercises. The best way to do this is to open two terminal windows. Use one window to work through the examples. When you get to a Task, first try it in the first window to see that you get the desired outcome then, using hash-commenting, copy the text of the Task onto the command line of the second window and carry out the task. This method also makes it easier to avoid having to edit extraneous content from the text file afterwards.
